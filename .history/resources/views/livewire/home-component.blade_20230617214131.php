    ...
    <div class="container">
                ...
                @foreach ($sliders as $slide)
                    <div class="item-slide">
                        ...
                        <div class="slide-info slide-1">
                            ...
                            <a href="{{$slide->link}}" class="btn-link">@lang("message.Shop Now")</a>
                        </div>
                    </div>
                @endforeach
            </div>
        ...
        @if ($sproducts->count() > 0 && $sale->status == 1 && $sale->sale_date > carbon\Carbon::now() )
            <div class="wrap-show-advance-info-box style-1 has-countdown">
                <h3 class="title-box">@lang("message.On Sale")</h3>
                    ...
                    <div class="product product-style-2 equal-elem ">
                        <div class="product-thumnail">
                            ...
                            <div class="group-flash">
                                <span class="flash-item sale-label">@lang("message.sale")</span>
                            </div>
                            {{-- <div class="wrap-btn">
                        ...
                        <div class="product-info">
                            ...
                            <div class="wrap-price"><ins>
                                    <p class="product-price">
                                        {{ number_format($sproduct->sale_price, 0, ',','.') }}₫
                                    </p>
                                </ins> <del>
                                    <p class="product-price">
                                        {{ number_format($sproduct->regular_price, 0, ',','.') }}₫
                                    </p>
                                </del></div>
                        </div>
                    </div>
        ...
        <div class="wrap-show-advance-info-box style-1">
            <h3 class="title-box">@lang("message.Latest Products")</h3>
                                        ...
                                        <div class="product-info">
                                            ...
                                            <div class="wrap-price">
                                                <span class="product-price">
                                                    {{ number_format($lproduct->regular_price, 0, ',','.') }}₫
                                                </span>
                                            </div>
                                        </div>
                                    </div>
        ...
        <!--Product Categories-->
        <div class="wrap-show-advance-info-box style-1">
            <h3 class="title-box">@lang("message.Product Categories")</h3>
            <div class="wrap-top-banner">
                <a href="#" class="link-banner banner-effect-2">
                                    ...
                                    @endphp
                                        @foreach ($c_products as $c_product)
                                            <div class="product product-style-2 equal-elem ">
                                                ...
                                                <div class="product-info">
                                                    <a href="{{route('product.details',['slug'=>$c_product->slug])}}" class="product-name"><span>{{$c_product->name}}</span>
                                                    </a>
                                                    <div class="wrap-price">
                                                        <span class="product-price">
                                                            {{ number_format($c_product->regular_price, 0, ',','.') }}₫
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
