        ...
        <div class="container">
            ...
            <div class="wrap-breadcrumb">
                <ul>
                    ...
                    <li class="item-link"><span>@lang("message.Wishlist")</span></li>
                </ul>
            </div>
            ...
            <div class="row">
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="wrap-price">
                                        <span class="product-price">
                                            {{ number_format($item->model->regular_price, 0, ',','.') }}₫
                                        </span>
                                    </div>

                                    <a href="#" class="btn add-to-cart"
                                        wire:click.prevent="moveProductFromWishlistToCart('{{$item->rowId}}')">
                                        @lang("message.Move to cart")
                                    </a>
                ...
                @else
                <h4>Không có sản phẩm được yếu thích nào trong đây</h4>
                @endif
            </div>
