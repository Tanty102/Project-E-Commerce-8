                    ...
                    <div class="panel-body">
                        <form action="" class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="password" placeholder="New Password" class="form-control input-md" name="password">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="" class="col-md-4 control-label">Confirm Password</label>
                                <div class="col-md-4">
                                    <input type="password" placeholder="Confirm Password" class="form-control input-md" name="password_confirm">
                                </div>
                            </div>
                            <div class="form-group">
