                            ...
                            <ul class="products-cart">
                                ...
                                <li class="pr-cart-item">
                                    ...
                                    <div class="price-field sub-total">
                                        <p class="price">{{ number_format($item->price * $item->quantity, 0, ',','.') }}₫</p>
                                    </div>
                                    @if ($order->status == "delivered" && $item->rstatus == false)    
                                        <div class="price-field sub-total">
                                            <p class="price"><a href="{{route("user.review",["order_item_id"]=>$item_id)}}">Write Review</a></p>
                                        </div>
                                    @endif
                                </li>
                                @endforeach
                        ...
                        <div class="summary">
                            <div class="order-summary">
                                ...
                                <p class="summary-info"><span class="title">Subtotal</span><b class="index">
                                    {{ number_format(floatval(str_replace(',', '', $order->subtotal)), 0, ',', '.') }}₫
                                    </b>
                                </p>
                                <p class="summary-info"><span class="title">Tax</span><b class="index">
                                    {{ number_format(floatval(str_replace(',', '', $order->tax)), 0, ',', '.') }}₫
                                    </b>
                                </p>
                                <p class="summary-info"><span class="title">Shipping</span><b class="index">Free Shipping</b></p>
                                <p class="summary-info"><span class="title">Total</span><b class="index">
                                    {{ number_format(floatval(str_replace(',', '', $order->total)), 0, ',', '.') }}₫
                                    </b>
                                </p>
                            </div>
                        </div>
