    ...
    <div class="container">
        ...
        <div class="wrap-breadcrumb">
            <ul>
                ...
                <li class="item-link"><span>@lang("message.Checkout")</span></li>
            </ul>
        </div>
        <div class=" main-content-area">
            ...
            <div class="row">
                        ...
                        <div class="billing-address">
                            ...
                            <p class="row-in-form fill-wife">
                                <label class="checkbox-field">
                                    ...
                                    <span>@lang("message.Ship to a different address")?</span>
                                </label>
                            </p>
                        </div>
                    </div>
                ...
                @if ($ship_to_different)
                    <div class="col-md-12">
                        <div class="wrap-address-billing">
                            <h3 class="box-title">@lang("message.Shipping Address")</h3>
                            <div class="billing-address">
                                <p class="row-in-form">
                                    <label for="fname">@lang("message.first name")<span>*</span></label>
                                ...
                                <p class="row-in-form">
                                    <label for="city">@lang("message.Province")<span>*</span></label>
                                    <input type="text" name="rovince" value="" placeholder="Province" wire:model='s_province'>
            ...
            <div class="summary summary-checkout">
                <div class="summary-item payment-method">
                    <h4 class="title-box">@lang("message.Payment Method")</h4>
                    @if ($paymentmode == 'card')
                        <div class="wrap-address-billing">
                            ...
                            @endif
                            <p class="row-in-form">
                                <label for="card-no">@lang("message.Card Number"):</label>
                            ...
                            <p class="row-in-form">
                                <label for="exp-month">@lang("message.Expiry Month"):</label>
                            ...
                            <p class="row-in-form">
                                <label for="exp-year">@lang("message.Expiry Year"):</label>
                    ...
                    <div class="choose-payment-methods">
                        <label class="payment-method">
                            ...
                            <span>@lang("message.Cash On Delivery")</span>
                            <span class="payment-desc">@lang("message.Order Now Pay On Delivery")</span>
                        </label>
                        <label class="payment-method">
                            <input name="payment-method" id="payment-method-visa" value="card" type="radio" wire:model='paymentmode'>
                            <span>Debit / Credit Card</span>
                            <span class="payment-desc">@lang("message.There are many variations of passages of Lorem Ipsum available")</span>
                        </label>
                        <label class="payment-method">
                            <input name="payment-method" id="payment-method-paypal" value="paypal" type="radio" wire:model='paymentmode'>
                            <span>Paypal</span>
                            <span class="payment-desc">@lang("message.You can pay with your credit")</span>
                            <span class="payment-desc">@lang("message.card if you do not have a paypal account")</span>
                        </label>
                        @error('paymentmode') <span class="text-danger">{{$message}}</span> @enderror
                    </div>
                    @if (Session::has('checkout'))
                        <p class="summary-info grand-total"><span>@lang("message.Grand Total")</span>
                    ...
                    @if ($errors->isEmpty())
                        <div wire:ignore id="processing" style="font-size: 22px; margin-bottom:20px; padding-left:38px; color:green; display:none;">
                            <i class="fa fa-spinner fa-pulse fa-fw"></i>
                            <span>@lang("message.Processing")...</span>
                        </div>
                    @endif

                    <button type="submit" class="btn btn-medium">@lang("message.Place order now")</button>
                </div>
                <div class="summary-item shipping-method">
                    <h4 class="title-box f-title">@lang("message.Shipping method")</h4>
                    <p class="summary-info"><span class="title">@lang("message.Flat Rate")</span></p>
                    <p class="summary-info"><span class="title">@lang("message.Fixed") 0</span></p>
