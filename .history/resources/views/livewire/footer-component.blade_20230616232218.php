                    ...
                    <ul>
                        <li class="fc-info-item">
                            ...
                            <div class="wrap-left-info">
                                <h4 class="fc-name">@lang("message.Free Shipping")</h4>
                                <p class="fc-desc">@lang("message.Free On Oder Over") 99</p>
                            </div>
                        ...
                        <li class="fc-info-item">
                            ...
                            <div class="wrap-left-info">
                                <h4 class="fc-name">@lang("message.Guarantee")</h4>
                                <p class="fc-desc">30 @lang("message.Days Money Back")</p>
                            </div>
                        ...
                        <li class="fc-info-item">
                            ...
                            <div class="wrap-left-info">
                                <h4 class="fc-name">@lang("message.Safe Payment")</h4>
                                <p class="fc-desc">@lang("message.Safe your online payment")</p>
                            </div>
                        ...
                        <li class="fc-info-item">
                            ...
                            <div class="wrap-left-info">
                                <h4 class="fc-name">@lang("message.Online Support")</h4>
                                <p class="fc-desc">@lang("message.We Have Support") 24/7</p>
                            </div>
            ...
            <div class="main-footer-content">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
                            <div class="wrap-footer-item">
                                <h3 class="item-header">@lang("message.Contact Details")</h3>
                        ...
                        <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
                            ...
                            <div class="wrap-footer-item">
                                <h3 class="item-header">@lang("message.Hot Line")</h3>
                                <div class="item-content">
                                    <div class="wrap-hotline-footer">
                                        <span class="desc">@lang("message.Call Us toll Free")</span>
                            ...
                            <div class="wrap-footer-item footer-item-second">
                                <h3 class="item-header">@lang("message.Sign up for newsletter")</h3>
                                <div class="item-content">
                                    <div class="wrap-newletter-footer">
                                        <form action="#" class="frm-newletter" id="frm-newletter">
                                            <input type="email" class="input-email" name="email" value="" placeholder="Enter your email address">
                                            <button class="btn-submit">@lang("message.Subscribe")</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12 box-twin-content ">
                            <div class="row">
                                <div class="wrap-footer-item twin-item">
                                    <h3 class="item-header">@lang("message.My Account")</h3>
                                    <div class="item-content">
                                        <div class="wrap-vertical-nav">
                                            <ul>
                                                <li class="menu-item"><a href="#" class="link-term">@lang("message.My Account")</a></li>
                                                <li class="menu-item"><a href="#" class="link-term">@lang("message.Brands")</a></li>
                                                <li class="menu-item"><a href="#" class="link-term">@lang("message.Gift Certificates")</a></li>
                                                <li class="menu-item"><a href="#" class="link-term">@lang("message.Affiliates")</a></li>
                                                <li class="menu-item"><a href="#" class="link-term">@lang("message.Wish list")</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                <div class="wrap-footer-item twin-item">
                                    <h3 class="item-header">@lang("message.Information")</h3>
                                    <div class="item-content">
                                        <div class="wrap-vertical-nav">
                                            <ul>
                                                <li class="menu-item"><a href="#" class="link-term">@lang("message.Contact Us")</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
                            <div class="wrap-footer-item">
                                <h3 class="item-header">@lang("message.We Using Safe Payments"):</h3>
                                <div class="item-content">
                        ...
                        <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
                            <div class="wrap-footer-item">
                                <h3 class="item-header">@lang("message.Social network")</h3>
                                <div class="item-content">
                                    <div class="wrap-list-item social-network">
                                        <ul>
                                            ...
                                            <li><a href="{{$setting->facebook}}" class="link-to-item" title="facebook"><i class="fa fa-facebook"
                                                        aria-hidden="true"></i></a></li>
                                            <li><a href="{{$setting->pinterest}}" class="link-to-item" title="pinterest"><i class="fa fa-pinterest"
                                                        aria-hidden="true"></i></a></li>
                                            <li><a href="{{$setting->instagram}}" class="link-to-item" title="instagram"><i class="fa fa-instagram"
                                                        aria-hidden="true"></i></a></li>
                        ...
                        <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
                            <div class="wrap-footer-item">
                                <h3 class="item-header">@lang("message.Download App")</h3>
                                <div class="item-content">
                                    <div class="wrap-list-item apps-list">
                                        <ul>
                                            ...
                                            <li><a href="#" class="link-to-item" title="our application on google play store">
                                                    <figure><img src="assets/images/brands/google-play-store.png" alt="google play store" width="128"
                                                            height="36"></figure>
                                                </a></li>
                                        </ul>
                                    </div>
            ...
            <div class="coppy-right-box">
                <div class="container">
                    <div class="coppy-right-item item-left">
                        <p class="coppy-right-text">Copyright © 2023 Nguyễn Tấn Tỵ</p>
                    </div>
