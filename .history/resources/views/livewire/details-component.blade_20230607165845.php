                ...
                <div class="wrap-product-detail">
                    ...
                    <div class="detail-info">
                        ...
                        <div class="wrap-social">
                            <a class="link-socail" href="#"><img src="{{ asset('assets/images/social-list.png') }}" alt="">
                            </a>
                        </div>
                        @if ($product->sale_price > 0 && $sale->status == 1 && $sale->sale_date > carbon\Carbon::now() )
                        <div class="wrap-price">
                            <span class="product-price">{{ number_format($product->sale_price, 0, ',','.') }}₫</span>
                            <del><span class="product-price regprice">
                        ...
                        @else
                        <div class="wrap-price">
                            <span class="product-price">{{ number_format($product->regular_price, 0, ',','.') }}₫</span>
                        </div>
                        @endif
                            ...
                            <div class="tab-content-item " id="review">
                                ...
                                <div class="wrap-review-form">
                                    ...
                                    <div id="comments">
                                        ...
                                        <p class="price"><a href="{{route("user.review",["order_item_id"=>$orderItems->id])}}">Write Review</a></p>
                                                    ...
                                                    <div class="comment-text">
                                                        ...
                                                        <p class="meta">
                                                            ...
                                                            <time class="woocommerce-review__published-date"
                                                                datetime="2008-02-14 20:00">{{Carbon\Carbon::parse($orderItem->review->created_at)->format("d F
                                                                Y g:i A")}}</time>
                                                        </p>
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="wrap-price">
                                            <span class="product-price">
                                                {{ number_format($p_product->regular_price, 0,',','.') }}₫
                                            </span>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="single-advance-box col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="wrap-show-advance-info-box style-1 box-in-site">
                    ...
                    <div class="wrap-products">
                        <div class="products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true"
                            data-dots="false"
                            ...
                            <div class="product product-style-2 equal-elem ">
                                <div class="product-thumnail">
                                    <a href="{{route ('product.details',['slug'=>$r_product->slug]) }}" title="{{$r_product->name}}">
                                        <figure><img src="{{ asset('assets/images/products') }}/{{$r_product->image}}" width="214" height="214"
