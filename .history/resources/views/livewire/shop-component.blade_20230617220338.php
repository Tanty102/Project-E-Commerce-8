        ...
        <div class="container">
            ...
            <div class="wrap-breadcrumb">
                <ul>
                    ...
                    <li class="item-link"><span>@lang("message.Digital & Electronics")</span></li>
                </ul>
            </div>
            <div class="row">
                ...
                <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
                    ...
                    <div class="wrap-shop-control">
                        ...
                        <h1 class="shop-title">@lang("message.Digital & Electronics")</h1>

                        <div class="wrap-right">

                            <div class="sort-item orderby ">
                                <select name="orderby" class="use-chosen" wire:model="sorting">
                                    <option value="default" selected="selected">@lang("message.Default sorting")</option>
                                    <option value="date">@lang("message.Sort by newness")</option>
                                    <option value="price">@lang("message.Sort by price: low to high")</option>
                                    <option value="price-desc">@lang("message.Sort by price: high to low")</option>
                                </select>
                            </div>

                            <div class="sort-item product-per-page">
                                <select name="post-per-page" class="use-chosen" wire:model="pagesize">
                                    <option value="12" selected="selected">12 @lang("message.per page")</option>
                                    <option value="16">16 @lang("message.per page")</option>
                                    <option value="18">18 @lang("message.per page")</option>
                                    <option value="21">21 @lang("message.per page")</option>
                                    <option value="24">24 @lang("message.per page")</option>
                                    <option value="30">30 @lang("message.per page")</option>
                                    <option value="32">32 @lang("message.per page")</option>
                                </select>
                            </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 sitebar">
                    ...
                    <div class="widget mercado-widget filter-widget brand-widget">
                        <h2 class="widget-title">@lang("message.Brand")</h2>
                        <div class="widget-content">
                            <ul class="list-style vertical-list list-limited" data-show="6">
                                <li class="list-item"><a class="filter-link active" href="#">@lang("message.Denmark")</a></li>
                                <li class="list-item"><a class="filter-link " href="#">@lang("message.England")</a></li>
                                <li class="list-item"><a class="filter-link " href="#">@lang("message.Finland")</a></li>
                                <li class="list-item"><a class="filter-link " href="#">@lang("message.Austria")</a></li>
                                <li class="list-item"><a class="filter-link " href="#">@lang("message.Belgium")</a></li>
                                <li class="list-item"><a class="filter-link " href="#">@lang("message.France")</a>
                                </li>
                                <li class="list-item default-hiden"><a class="filter-link " href="#">@lang("message.Germany")</a>
                                </li>
                                <li class="list-item default-hiden"><a class="filter-link " href="#">@lang("message.Netherlands")</a>
                                </li>
                                <li class="list-item default-hiden"><a class="filter-link " href="#">@lang("message.Italy")</a>
                                </li>
                                <li class="list-item default-hiden"><a class="filter-link " href="#">@lang("message.Portugal")</a></li>
                    ...
                    <div class="widget mercado-widget filter-widget price-filter">
                        <h2 class="widget-title">@lang("message.Price") 
                                    ...
                                    <div class="product product-widget-style">
                                        ...
                                        <div class="product-info">
                                            <a href="#" class="product-name"><span>Radiant-360 R6 Wireless
                                                    Omnidirectional
                                                    Speaker...</span></a>
                                            <div class="wrap-price"><span class="product-price">168.000</span></div>
                                        </div>
                                    </div>
                                </li>
                                    ...
                                    <div class="product product-widget-style">
                                        ...
                                        <div class="product-info">
                                            <a href="#" class="product-name"><span>Radiant-360 R6 Wireless
                                                    Omnidirectional
                                                    Speaker...</span></a>
                                            <div class="wrap-price"><span class="product-price">168.020</span></div>
                                        </div>
                                    </div>
                                </li>
                                    ...
                                    <div class="product product-widget-style">
                                        ...
                                        <div class="product-info">
                                            <a href="#" class="product-name"><span>Radiant-360 R6 Wireless
                                                    Omnidirectional
                                                    Speaker...</span></a>
                                            <div class="wrap-price"><span class="product-price">168.700</span></div>
                                        </div>
                                    </div>
                                </li>
                                    ...
                                    <div class="product product-widget-style">
                                        ...
                                        <div class="product-info">
                                            <a href="#" class="product-name"><span>Radiant-360 R6 Wireless
                                                    Omnidirectional
                                                    Speaker...</span></a>
                                            <div class="wrap-price"><span class="product-price">168.200</span></div>
                                        </div>
                                    </div>
                                </li>
